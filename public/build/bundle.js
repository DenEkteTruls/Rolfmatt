...
var app = (function () {
    ...
    // (51:4) <Canvas width={600} height={600} on:mousedown={clicked}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(51:4) <Canvas width={600} height={600} on:mousedown={clicked}>",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	canvas.$on("mousedown", /*clicked*/ ctx[1]);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 49, 0, 1563);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
